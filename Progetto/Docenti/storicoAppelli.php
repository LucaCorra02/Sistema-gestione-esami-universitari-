  ...
  <body>
            ...
            <tbody class="ricerca">
                <?php   
                    ...
                    while ($res = pg_fetch_row($row)) {        
                        ...
                        $btn = "<form method='post' action='storicoVoti.php'><button type='submit' id = '".$res[0]."' class='btn btn-primary' name='iscrizioni' value='".$res[0]."'>Iscrizioni</button></form>";
                        if ($totale ==0){
    ...
    <?php
         if ($cont==1){
            ...
            echo "<div class='alert alert-warning centroS' role='alert'><h4>Nessun appello trovato. <a href='creaAppelli.php' class='alert-link'>Crea Appelli</a></h4>
            </div>";
          }
        require("../footer.php");
    ?>
