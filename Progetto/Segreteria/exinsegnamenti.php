...
<html lang="en">
  ...
  <body>
    <?php
      ...
      $row = pg_execute($connesione, "", array($_POST["exdocenze"]));
    ?>
    ...
    <?php
        if ($cont==1){
            ...
            echo "<div class='alert alert-warning centroS' role='alert'><h4>Nessun Insegnamento pregresso.</h4>
            </div>";
          }
        require("../footer.php");
        if($cont <= 5){
